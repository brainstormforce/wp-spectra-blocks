<?php
/**
 * Spectra Block Stats Background Processor.
 *
...
if ( ! class_exists( 'WP_Async_Request' ) ) {
	require_once SPECTRA_DIR . 'lib/batch-processing/class-wp-async-request.php';
}

if ( ! class_exists( 'WP_Background_Process' ) ) {
	require_once SPECTRA_DIR . 'lib/batch-processing/class-wp-background-process.php';
}

if ( ! class_exists( 'Spectra_Block_Stats_Processor' ) ) {

	/**
	 * Class Spectra_Block_Stats_Processor
	 *
	 ...
	 * @package Spectra
	 */
	class Spectra_Block_Stats_Processor extends WP_Background_Process {
		 ...
		 * @since 0.0.1
		 */
		protected $action = 'spectra_block_stats_collection';
		...
		protected function task( $post_id ) {
			...
			$analytics_data = get_option( 'spectra_block_analytics_data', array() );
			...
			update_option( 'spectra_block_analytics_data', $analytics_data );
		...
		protected function complete() {
			...
			$status = get_option( 'spectra_block_analytics_status', array() );
			...
			update_option( 'spectra_block_analytics_status', $status );
		}
		...
		public function start_collection() {
			...
			update_option( 'spectra_block_analytics_data', array() );
