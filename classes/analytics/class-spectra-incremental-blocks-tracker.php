<?php
/**
 * Spectra Incremental Block Tracker.
 *
...
if ( ! class_exists( 'Spectra_Incremental_Block_Tracker' ) ) {

	/**
	 * Class Spectra_Incremental_Block_Tracker
	 *
	...
	class Spectra_Incremental_Block_Tracker {
		 ...
		 * Member Variable
		 *
		 * @var Spectra_Incremental_Block_Tracker|null
		 * @since 0.0.1
		 */
		 ...
		 *
		 * @since 0.0.1
		 * @return Spectra_Incremental_Block_Tracker
		 */
