<?php
/**
 * Spectra Block Analytics Manager.
 *
...
if ( ! class_exists( 'Spectra_Block_Analytics' ) ) {

	/**
	 * Class Spectra_Block_Analytics
	 *
	...
	class Spectra_Block_Analytics {
		 ...
		 * Member Variable
		 *
		 * @var Spectra_Block_Analytics|null
		 * @since 0.0.1
		 */
		 ...
		 *
		 * @var Spectra_Block_Stats_Processor
		 * @since 0.0.1
		 */
		 ...
		 *
		 * @var Spectra_Incremental_Block_Tracker
		 * @since 0.0.1
		 */
		 ...
		 *
		 * @since 0.0.1
		 * @return Spectra_Block_Analytics
		 */
		...
		public function get_block_stats_for_analytics( $existing_stats = array() ) {
			...
			$stats               = Spectra_Block_Stats_Processor::get_block_stats();
			$collection_complete = Spectra_Block_Stats_Processor::is_collection_complete();
			$last_collection     = Spectra_Block_Stats_Processor::get_last_collection_time();
