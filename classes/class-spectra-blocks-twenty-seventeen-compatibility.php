<?php
/**
 * Spectra Twenty Seventeen Compatibility.
 *
 * @package Spectra
 */
...
if ( ! class_exists( 'Spectra_Twenty_Seventeen_Compatibility' ) ) {

	/**
	 * Class Spectra_Twenty_Seventeen_Compatibility.
	 */
...
Spectra_Twenty_Seventeen_Compatibility::get_instance();
