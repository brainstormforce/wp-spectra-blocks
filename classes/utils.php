<?php
/**
 * Utility functions for Spectra Blocks.
 *
...
if ( ! function_exists( 'spectra_blocks_get_font_awesome_polyfiller' ) ) {
	/**
	 * Returns the Font Awesome 5 to Font Awesome 6 icon mapping array.
	 * Used for backward compatibility with content that uses FA5 icon names.
	 *
	 * @return array FA5 => FA6 icon name mapping.
	 */
