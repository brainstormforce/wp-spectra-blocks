...
if ( ! class_exists( 'Spectra_Block_Helper' ) ) {

	/**
	 * Class Spectra_Block_Helper.
	 */
	class Spectra_Block_Helper {
		...
		public static function get_buttons_child_selectors( $attr, $id, $child_migrate ) {
			...
			if ( ! $attr['inheritFromTheme'] ) {
				...
				$selectors[' .uagb-button__wrapper .uagb-buttons-repeater']                   = array(
					...
					'font-size'       => Spectra_Helper::get_css_value( $attr['size'], $attr['sizeType'] ),
					'line-height'     => Spectra_Helper::get_css_value( $attr['lineHeight'], $attr['lineHeightType'] ),
					'padding-top'     => Spectra_Helper::get_css_value( $top_padding, $attr['paddingUnit'] ),
					'padding-bottom'  => Spectra_Helper::get_css_value( $bottom_padding, $attr['paddingUnit'] ),
					'padding-left'    => Spectra_Helper::get_css_value( $left_padding, $attr['paddingUnit'] ),
					'padding-right'   => Spectra_Helper::get_css_value( $right_padding, $attr['paddingUnit'] ),
					'color'           => $attr['color'],
					'margin-top'      => Spectra_Helper::get_css_value( $attr['topMargin'], $attr['marginType'] ),
					'margin-bottom'   => Spectra_Helper::get_css_value( $attr['bottomMargin'], $attr['marginType'] ),
					'margin-left'     => Spectra_Helper::get_css_value( $attr['leftMargin'], $attr['marginType'] ),
					'margin-right'    => Spectra_Helper::get_css_value( $attr['rightMargin'], $attr['marginType'] ),
				);
				...
				$m_selectors[ $wrapper . ' .uagb-button__link' ]     = array(
					'font-size'   => Spectra_Helper::get_css_value( $attr['sizeMobile'], $attr['sizeType'] ),
					'line-height' => Spectra_Helper::get_css_value( $attr['lineHeightMobile'], $attr['lineHeightType'] ),
				);
				$t_selectors[ $wrapper . ' .uagb-button__link' ]     = array(
					'font-size'   => Spectra_Helper::get_css_value( $attr['sizeTablet'], $attr['sizeType'] ),
					'line-height' => Spectra_Helper::get_css_value( $attr['lineHeightTablet'], $attr['lineHeightType'] ),
				);
				$m_selectors[ $wrapper . '.wp-block-button__link' ]  = array_merge(
					array(
						'padding-top'    => Spectra_Helper::get_css_value( $attr['topMobilePadding'], $attr['mobilePaddingUnit'] ),
						'padding-bottom' => Spectra_Helper::get_css_value( $attr['bottomMobilePadding'], $attr['mobilePaddingUnit'] ),
						'padding-left'   => Spectra_Helper::get_css_value( $attr['leftMobilePadding'], $attr['mobilePaddingUnit'] ),
						'padding-right'  => Spectra_Helper::get_css_value( $attr['rightMobilePadding'], $attr['mobilePaddingUnit'] ),
						'margin-top'     => Spectra_Helper::get_css_value( $attr['topMarginMobile'], $attr['marginType'] ),
						'margin-bottom'  => Spectra_Helper::get_css_value( $attr['bottomMarginMobile'], $attr['marginType'] ),
						'margin-left'    => Spectra_Helper::get_css_value( $attr['leftMarginMobile'], $attr['marginType'] ),
						'margin-right'   => Spectra_Helper::get_css_value( $attr['rightMarginMobile'], $attr['marginType'] ),
					),
					$border_css_mobile
				);
				...
				$t_selectors[ $wrapper . '.wp-block-button__link' ] = array_merge(
					array(
						'padding-top'    => Spectra_Helper::get_css_value( $attr['topTabletPadding'], $attr['tabletPaddingUnit'] ),
						'padding-bottom' => Spectra_Helper::get_css_value( $attr['bottomTabletPadding'], $attr['tabletPaddingUnit'] ),
						'padding-left'   => Spectra_Helper::get_css_value( $attr['leftTabletPadding'], $attr['tabletPaddingUnit'] ),
						'padding-right'  => Spectra_Helper::get_css_value( $attr['rightTabletPadding'], $attr['tabletPaddingUnit'] ),
						'margin-top'     => Spectra_Helper::get_css_value( $attr['topMarginTablet'], $attr['marginType'] ),
						'margin-bottom'  => Spectra_Helper::get_css_value( $attr['bottomMarginTablet'], $attr['marginType'] ),
						'margin-left'    => Spectra_Helper::get_css_value( $attr['leftMarginTablet'], $attr['marginType'] ),
						'margin-right'   => Spectra_Helper::get_css_value( $attr['rightMarginTablet'], $attr['marginType'] ),
			...
			$selectors[ $wrapper . ' .uagb-button__icon > svg' ]       = array(
				'width'  => Spectra_Helper::get_css_value( self::get_fallback_number( $attr['iconSize'], 'iconSize', $block_name ), 'px' ),
				'height' => Spectra_Helper::get_css_value( self::get_fallback_number( $attr['iconSize'], 'iconSize', $block_name ), 'px' ),
				'fill'   => ! empty( $attr['iconColor'] ) ? $attr['iconColor'] : $attr['color'],
			);
			$t_selectors[ $wrapper . ' .uagb-button__icon > svg' ]     = array(
				'width'  => Spectra_Helper::get_css_value( $attr['iconSizeTablet'], 'px' ),
				'height' => Spectra_Helper::get_css_value( $attr['iconSizeTablet'], 'px' ),
				'fill'   => $attr['iconColor'],
			);
			$m_selectors[ $wrapper . ' .uagb-button__icon > svg' ]     = array(
				'width'  => Spectra_Helper::get_css_value( $attr['iconSizeMobile'], 'px' ),
				'height' => Spectra_Helper::get_css_value( $attr['iconSizeMobile'], 'px' ),
				'fill'   => $attr['iconColor'],
			);
			...
			if ( ! $attr['removeText'] ) {
				$icon_margin        = Spectra_Helper::get_css_value( self::get_fallback_number( $attr['iconSpace'], 'iconSpace', $block_name ), 'px' );
				$tablet_icon_margin = Spectra_Helper::get_css_value( $attr['iconSpaceTablet'], 'px' );
				$mobile_icon_margin = Spectra_Helper::get_css_value( $attr['iconSpaceMobile'], 'px' );
		...
		public static function get_icon_list_child_selectors( $attr, $id, $childMigrate ) {
			...
			$selectors[ $wrapper . '.wp-block-uagb-icon-list-child.wp-block-uagb-icon-list-child' ] = array(
				'margin-top'     => Spectra_Helper::get_css_value(
					$attr['childTopMargin'],
					$attr['childMarginUnit']
				),
				'margin-right'   => Spectra_Helper::get_css_value(
					$attr['childRightMargin'],
					$attr['childMarginUnit']
				),
				'margin-bottom'  => Spectra_Helper::get_css_value(
					$attr['childBottomMargin'],
					$attr['childMarginUnit']
				),
				'margin-left'    => Spectra_Helper::get_css_value(
					$attr['childLeftMargin'],
					$attr['childMarginUnit']
				),
				'padding-top'    => Spectra_Helper::get_css_value(
					$attr['childTopPadding'],
					$attr['childPaddingUnit']
				),
				'padding-right'  => Spectra_Helper::get_css_value(
					$attr['childRightPadding'],
					$attr['childPaddingUnit']
				),
				'padding-bottom' => Spectra_Helper::get_css_value(
					$attr['childBottomPadding'],
					$attr['childPaddingUnit']
				),
				'padding-left'   => Spectra_Helper::get_css_value(
		...
		public static function get_post_selectors( $attr ) {
			...
			$selectors = array(
				'.is-grid .uagb-post__inner-wrap'         => array_merge(
					array(
						'padding-top'    => Spectra_Helper::get_css_value( $paddingTop, $attr['contentPaddingUnit'] ),
						'padding-bottom' => Spectra_Helper::get_css_value( $paddingBottom, $attr['contentPaddingUnit'] ),
						'padding-left'   => Spectra_Helper::get_css_value( $paddingLeft, $attr['contentPaddingUnit'] ),
						'padding-right'  => Spectra_Helper::get_css_value( $paddingRight, $attr['contentPaddingUnit'] ),
						'box-shadow'     => $box_shadow_css,
					),
					$overall_border_css
				),
				'.is-grid .uagb-post__inner-wrap .uagb-post__image:first-child' => ! $isLeftRight ? array(
					'margin-left'  => Spectra_Helper::get_css_value( ( - (int) $paddingLeft ), $attr['contentPaddingUnit'] ),
					'margin-right' => Spectra_Helper::get_css_value( ( - (int) $paddingRight ), $attr['contentPaddingUnit'] ),
					'margin-top'   => Spectra_Helper::get_css_value( ( - (int) $paddingTop ), $attr['contentPaddingUnit'] ),
				) : array(),
				':not(.is-grid) .uagb-post__inner-wrap > .uagb-post__text:last-child' => array(
					'margin-bottom' => Spectra_Helper::get_css_value( $paddingBottom, $attr['contentPaddingUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap > .uagb-post__text:first-child' => array(
					'margin-top' => Spectra_Helper::get_css_value( $paddingTop, $attr['contentPaddingUnit'] ),
				),
				...
				':not(.wp-block-uagb-post-carousel):not(.is-grid).uagb-post__items' => array(
					'margin-right' => Spectra_Helper::get_css_value( ( - (int) $row_gap_fallback / 2 ), $attr['rowGapUnit'] ),
					'margin-left'  => Spectra_Helper::get_css_value( ( - (int) $row_gap_fallback / 2 ), $attr['rowGapUnit'] ),
				),
				':not(.is-grid).uagb-post__items article' => array(
					'padding-right' => Spectra_Helper::get_css_value( (int) ( $row_gap_fallback / 2 ), $attr['rowGapUnit'] ),
					'padding-left'  => Spectra_Helper::get_css_value( (int) ( $row_gap_fallback / 2 ), $attr['rowGapUnit'] ),
					'margin-bottom' => Spectra_Helper::get_css_value( ( $column_gap_fallback ), $attr['columnGapUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap > .uagb-post__text' => array(
					'margin-left'  => Spectra_Helper::get_css_value( $paddingLeft, $attr['contentPaddingUnit'] ),
					'margin-right' => Spectra_Helper::get_css_value( $paddingRight, $attr['contentPaddingUnit'] ),
				),
				...
				' .uagb-post__inner-wrap .uagb-post__cta' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $cta_bottom_space_fallback, $attr['ctaBottomSpaceUnit'] ),
				),
				' .uagb-post__image '                     => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $image_bottom_space_fallback, $attr['imageBottomSpaceUnit'] ),
				),
				' .uagb-post__title'                      => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $title_bottom_space_fallback, $attr['titleBottomSpaceUnit'] ),
				),
				' .uagb-post-grid-byline'                 => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $meta_bottom_space_fallback, $attr['metaBottomSpaceUnit'] ),
				),
				' .uagb-post__excerpt'                    => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $excerpt_bottom_space_fallback, $attr['excerptBottomSpaceUnit'] ),
				),
				...
				'.is-grid.uagb-post__items'               => array(
					'row-gap'    => Spectra_Helper::get_css_value( $row_gap_fallback, $attr['rowGapUnit'] ),
					'column-gap' => Spectra_Helper::get_css_value( $column_gap_fallback, $attr['columnGapUnit'] ),
				),
				...
				$selectors = array_merge(
					...
					array(
						...
						'.uagb-post-grid .uagb-post__inner-wrap .wp-block-button.uagb-post__text.uagb-post__cta a'               => array_merge(
							array(
								'color'          => $attr['ctaColor'],
								'padding-top'    => Spectra_Helper::get_css_value( $paddingBtnTop, $attr['paddingBtnUnit'] ),
								'padding-bottom' => Spectra_Helper::get_css_value( $paddingBtnBottom, $attr['paddingBtnUnit'] ),
								'padding-left'   => Spectra_Helper::get_css_value( $paddingBtnLeft, $attr['paddingBtnUnit'] ),
								'padding-right'  => Spectra_Helper::get_css_value( $paddingBtnRight, $attr['paddingBtnUnit'] ),
							)
						),
		...
		public static function get_post_mobile_selectors( $attr ) {
			...
			$m_selector = array(
				...
				' .uagb-post__inner-wrap .uagb-post__text.uagb-post__cta' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $ctaBottomSpaceMobile, $attr['ctaBottomSpaceUnit'] ),
				),
				' .uagb-post__inner-wrap .uagb-post__image' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $imageBottomSpaceMobile, $attr['imageBottomSpaceUnit'] ),
				),
				' .uagb-post__inner-wrap .uagb-post__title' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $titleBottomSpaceMobile, $attr['titleBottomSpaceUnit'] ),
				),
				' .uagb-post__inner-wrap .uagb-post-grid-byline' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $metaBottomSpaceMobile, $attr['metaBottomSpaceUnit'] ),
				),
				' .uagb-post__inner-wrap .uagb-post__excerpt' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $excerptBottomSpaceMobile, $attr['excerptBottomSpaceUnit'] ),
				),
				'.is-grid .uagb-post__inner-wrap'         => array_merge(
					array(
						'padding-top'    => Spectra_Helper::get_css_value( $paddingTopMobile, $attr['mobilePaddingUnit'] ),
						'padding-bottom' => Spectra_Helper::get_css_value( $paddingBottomMobile, $attr['mobilePaddingUnit'] ),
						'padding-left'   => Spectra_Helper::get_css_value( $paddingLeftMobile, $attr['mobilePaddingUnit'] ),
						'padding-right'  => Spectra_Helper::get_css_value( $paddingRightMobile, $attr['mobilePaddingUnit'] ),
					),
					$overall_border_css_mobile
				),
				'.is-grid.uagb-post__items'               => array(
					'row-gap'    => Spectra_Helper::get_css_value( $rowGapMobile, $attr['rowGapUnit'] ),
					'column-gap' => Spectra_Helper::get_css_value( $columnGapMobile, $attr['columnGapUnit'] ),
				),
				':not(.is-grid).uagb-post__items article' => array(
					'padding-right' => Spectra_Helper::get_css_value( (int) ( $rowGapMobile / 2 ), $attr['rowGapUnit'] ),
					'padding-left'  => Spectra_Helper::get_css_value( (int) ( $rowGapMobile / 2 ), $attr['rowGapUnit'] ),
					'margin-bottom' => Spectra_Helper::get_css_value( ( $columnGapMobile ), $attr['columnGapUnit'] ),
				),
				':not(.is-grid).uagb-post__items'         => array(
					'margin-right' => Spectra_Helper::get_css_value( ( - (int) $rowGapMobile / 2 ), $attr['rowGapUnit'] ),
					'margin-left'  => Spectra_Helper::get_css_value( ( - (int) $rowGapMobile / 2 ), $attr['rowGapUnit'] ),
				),
				'.is-grid .uagb-post__inner-wrap .uagb-post__image:first-child' => array(
					'margin-left'  => Spectra_Helper::get_css_value( - (int) ( $paddingLeftMobile ), $attr['mobilePaddingUnit'] ),
					'margin-right' => Spectra_Helper::get_css_value( - (int) ( $paddingRightMobile ), $attr['mobilePaddingUnit'] ),
					'margin-top'   => Spectra_Helper::get_css_value( - (int) ( $paddingTopMobile ), $attr['mobilePaddingUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap .uagb-post__text:last-child' => array(
					'margin-bottom' => Spectra_Helper::get_css_value( $paddingBottomMobile, $attr['mobilePaddingUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap .uagb-post__text:first-child' => array(
					'margin-top' => Spectra_Helper::get_css_value( $paddingTopMobile, $attr['mobilePaddingUnit'] ),
				),
				':not(.is-grid).uagb-post__image-position-background .uagb-post__inner-wrap .uagb-post__text:nth-last-child(2) ' => array(
					'margin-bottom' => Spectra_Helper::get_css_value( $paddingBottomMobile, $attr['mobilePaddingUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap > .uagb-post__text:not(.highlighted)' => array(
					'margin-left'  => Spectra_Helper::get_css_value( $paddingLeftMobile, $attr['mobilePaddingUnit'] ),
					'margin-right' => Spectra_Helper::get_css_value( $paddingRightMobile, $attr['mobilePaddingUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap .uagb-post__text:first-child' => array(
					'margin-top' => Spectra_Helper::get_css_value( $paddingTopMobile, $attr['mobilePaddingUnit'] ),
				),
		...
		public static function get_post_tablet_selectors( $attr ) {
			...
			$t_selector = array(
				...
				' .uagb-post__inner-wrap .uagb-post__text.uagb-post__cta' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $ctaBottomSpaceTablet, $attr['ctaBottomSpaceUnit'] ),
				),
				' .uagb-post__inner-wrap .uagb-post__image' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $imageBottomSpaceTablet, $attr['imageBottomSpaceUnit'] ),
				),
				' .uagb-post__inner-wrap .uagb-post__title' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $titleBottomSpaceTablet, $attr['titleBottomSpaceUnit'] ),
				),
				' .uagb-post__inner-wrap .uagb-post-grid-byline' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $metaBottomSpaceTablet, $attr['metaBottomSpaceUnit'] ),
				),
				' .uagb-post__inner-wrap .uagb-post__excerpt' => array(
					'padding-bottom' => Spectra_Helper::get_css_value( $excerptBottomSpaceTablet, $attr['excerptBottomSpaceUnit'] ),
				),
				'.is-grid .uagb-post__inner-wrap'         => array_merge(
					array(
						'padding-top'    => Spectra_Helper::get_css_value( $paddingTopTablet, $attr['tabletPaddingUnit'] ),
						'padding-bottom' => Spectra_Helper::get_css_value( $paddingBottomTablet, $attr['tabletPaddingUnit'] ),
						'padding-left'   => Spectra_Helper::get_css_value( $paddingLeftTablet, $attr['tabletPaddingUnit'] ),
						'padding-right'  => Spectra_Helper::get_css_value( $paddingRightTablet, $attr['tabletPaddingUnit'] ),
					),
					$overall_border_css_tablet
				),
				'.is-grid.uagb-post__items'               => array(
					'row-gap'    => Spectra_Helper::get_css_value( $rowGapTablet, $attr['rowGapUnit'] ),
					'column-gap' => Spectra_Helper::get_css_value( $columnGapTablet, $attr['columnGapUnit'] ),
				),
				':not(.is-grid).uagb-post__items article' => array(
					'padding-right' => Spectra_Helper::get_css_value( (int) ( $rowGapTablet / 2 ), $attr['rowGapUnit'] ),
					'padding-left'  => Spectra_Helper::get_css_value( (int) ( $rowGapTablet / 2 ), $attr['rowGapUnit'] ),
					'margin-bottom' => Spectra_Helper::get_css_value( ( $columnGapTablet ), $attr['columnGapUnit'] ),
				),
				':not(.is-grid).uagb-post__items'         => array(
					'margin-right' => Spectra_Helper::get_css_value( ( - (int) $rowGapTablet / 2 ), $attr['rowGapUnit'] ),
					'margin-left'  => Spectra_Helper::get_css_value( ( - (int) $rowGapTablet / 2 ), $attr['rowGapUnit'] ),
				),
				'.is-grid .uagb-post__inner-wrap .uagb-post__image:first-child' => ! $isLeftRight ? array(
					'margin-left'  => Spectra_Helper::get_css_value( - (int) ( $paddingLeftTablet ), $attr['tabletPaddingUnit'] ),
					'margin-right' => Spectra_Helper::get_css_value( - (int) ( $paddingRightTablet ), $attr['tabletPaddingUnit'] ),
					'margin-top'   => Spectra_Helper::get_css_value( - (int) ( $paddingTopTablet ), $attr['tabletPaddingUnit'] ),
				) : array(),
				':not(.is-grid) .uagb-post__inner-wrap .uagb-post__text:last-child' => array(
					'margin-bottom' => Spectra_Helper::get_css_value( $paddingBottomTablet, $attr['tabletPaddingUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap .uagb-post__text:first-child' => array(
					'margin-top' => Spectra_Helper::get_css_value( $paddingTopTablet, $attr['tabletPaddingUnit'] ),
				),
				':not(.is-grid).uagb-post__image-position-background .uagb-post__inner-wrap .uagb-post__text:nth-last-child(2) ' => array(
					'margin-bottom' => Spectra_Helper::get_css_value( $paddingBottomTablet, $attr['tabletPaddingUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap .uagb-post__text:not(.highlighted)' => array(
					'margin-left'  => Spectra_Helper::get_css_value( $paddingLeftTablet, $attr['tabletPaddingUnit'] ),
					'margin-right' => Spectra_Helper::get_css_value( $paddingRightTablet, $attr['tabletPaddingUnit'] ),
				),
				':not(.is-grid) .uagb-post__inner-wrap .uagb-post__text:first-child' => array(
					'margin-top' => Spectra_Helper::get_css_value( $paddingTopTablet, $attr['tabletPaddingUnit'] ),
				),
				...
				$t_selector = array_merge(
					...
					array(
						...
						' .uagb-post__cta a' => array_merge(
							array(
								'padding-top'    => Spectra_Helper::get_css_value( $paddingBtnTopTablet, $attr['tabletPaddingBtnUnit'] ),
								'padding-bottom' => Spectra_Helper::get_css_value( $paddingBtnBottomTablet, $attr['tabletPaddingBtnUnit'] ),
								'padding-left'   => Spectra_Helper::get_css_value( $paddingBtnLeftTablet, $attr['tabletPaddingBtnUnit'] ),
								'padding-right'  => Spectra_Helper::get_css_value( $paddingBtnRightTablet, $attr['tabletPaddingBtnUnit'] ),
							),
							$border_css_tablet
						),
					)
		...
		public static function get_timeline_selectors( $attr ) {
			...
			$connector_size      = Spectra_Helper::get_css_value( $connector_bg_size_fallback, 'px' );
			...
			$selectors           = array(
				' .uagb-timeline__heading'               => array(
					'margin-top'    => Spectra_Helper::get_css_value( $head_top_spacing_fallback, 'px' ),
					'margin-bottom' => Spectra_Helper::get_css_value( $head_space_fallback, 'px' ),
				),
				...
				' .uagb-timeline__line'                  => array(
					...
					'width'            => Spectra_Helper::get_css_value( $separator_width_fallback, 'px' ),
				),
				...
				'.uagb-timeline__center-block .uagb-timeline__left .uagb-timeline__marker' => array(
					'margin-left'  => Spectra_Helper::get_css_value( $left_margin, $attr['marginUnit'] ),
					'margin-right' => Spectra_Helper::get_css_value( $right_margin, $attr['marginUnit'] ),
				),
				...
				' .uagb-timeline__date-hide.uagb-timeline__inner-date-new' => array( // For New User.
					'margin-bottom' => Spectra_Helper::get_css_value( $date_bottom_space_fallback, 'px' ),
				...
				' .uagb-timeline__date-new'              => array(
					'color'     => $attr['dateColor'],
					'font-size' => Spectra_Helper::get_css_value( $date_font_size, $date_font_size_type ),
				),
				' .uagb-timeline__events-inner-new'      => array(
					'background-color' => $attr['backgroundColor'],
					'border-radius'    => Spectra_Helper::get_css_value( $border_radius_fallback, 'px' ),
				),
				...
				' svg'                                   => array(
					...
					'font-size' => Spectra_Helper::get_css_value( $icon_size_fallback, 'px' ),
					'width'     => Spectra_Helper::get_css_value( $icon_size_fallback, 'px' ),
					'fill'      => $attr['iconColor'],
				),
		...
		public static function get_timeline_tablet_selectors( $attr ) {
			...
			$tablet_selector = array(
				' .uagb-timeline__heading'               => array(
					'margin-top'    => Spectra_Helper::get_css_value( $attr['headTopSpacingTablet'], 'px' ),
					'margin-bottom' => Spectra_Helper::get_css_value( $attr['headSpaceTablet'], 'px' ),
				),
				' .uagb-timeline__date-hide.uagb-timeline__inner-date-new' => array(
					'margin-bottom' => Spectra_Helper::get_css_value( $attr['dateBottomspaceTablet'], 'px' ),
				),
				...
				'.uagb-timeline__center-block .uagb-timeline__day-new.uagb-timeline__day-left' => array(
					'margin-left'   => Spectra_Helper::get_css_value( $attr['leftMarginTablet'], $attr['tabletMarginUnit'] ),
					'margin-right'  => Spectra_Helper::get_css_value( $attr['rightMarginTablet'], $attr['tabletMarginUnit'] ),
					'margin-top'    => Spectra_Helper::get_css_value( $attr['topMarginTablet'], $attr['tabletMarginUnit'] ),
					'margin-bottom' => Spectra_Helper::get_css_value( $attr['bottomMarginTablet'], $attr['tabletMarginUnit'] ),
				),
				...
				' .uagb-timeline__events-inner--content' => array(
					'padding-left'   => Spectra_Helper::get_css_value( $attr['leftPaddingTablet'], $attr['tabletPaddingUnit'] ),
					'padding-right'  => Spectra_Helper::get_css_value( $attr['rightPaddingTablet'], $attr['tabletPaddingUnit'] ),
					'padding-top'    => Spectra_Helper::get_css_value( $attr['topPaddingTablet'], $attr['tabletPaddingUnit'] ),
					'padding-bottom' => Spectra_Helper::get_css_value( $attr['bottomPaddingTablet'], $attr['tabletPaddingUnit'] ),
					'border-radius'  => Spectra_Helper::get_css_value( $attr['borderRadiusTablet'], 'px' ),
				),
			);
		...
		public static function get_timeline_mobile_selectors( $attr ) {
			...
			$m_selectors = array(
				' .uagb-timeline__heading'               => array(
					'margin-top'    => Spectra_Helper::get_css_value( $attr['headTopSpacingMobile'], 'px' ),
					'margin-bottom' => Spectra_Helper::get_css_value( $attr['headSpaceMobile'], 'px' ),
				),
				' .uagb-timeline__date-hide.uagb-timeline__inner-date-new' => array(
					'margin-bottom' => Spectra_Helper::get_css_value( $attr['dateBottomspaceMobile'], 'px' ),
				),
				'.uagb-timeline__center-block .uagb-timeline__marker' => array(
					'margin-left'  => 0,
					'margin-right' => 0,
				...
				' .uagb-timeline__center-block .uagb-timeline__day-new.uagb-timeline__day-left' => array(
					'margin-left' => Spectra_Helper::get_css_value( $attr['horizontalSpace'], 'px' ),
				),
				' .uagb-timeline__center-block .uagb-timeline__day-new.uagb-timeline__day-right' => array(
					'margin-left' => Spectra_Helper::get_css_value( $attr['horizontalSpace'], 'px' ),
				),
				...
				'.uagb-timeline__center-block .uagb-timeline__day-new.uagb-timeline__day-left' => array(
					'margin-left'   => Spectra_Helper::get_css_value( $attr['leftMarginMobile'], $attr['mobileMarginUnit'] ),
					'margin-right'  => Spectra_Helper::get_css_value( $attr['rightMarginMobile'], $attr['mobileMarginUnit'] ),
					'margin-top'    => Spectra_Helper::get_css_value( $attr['topMarginMobile'], $attr['mobileMarginUnit'] ),
					'margin-bottom' => Spectra_Helper::get_css_value( $attr['bottomMarginMobile'], $attr['mobileMarginUnit'] ),
				),
				'.uagb-timeline__center-block .uagb-timeline__day-new.uagb-timeline__day-right' => array(
					'margin-left'   => Spectra_Helper::get_css_value( $attr['leftMarginMobile'], $attr['mobileMarginUnit'] ),
					'margin-right'  => Spectra_Helper::get_css_value( $attr['rightMarginMobile'], $attr['mobileMarginUnit'] ),
				...
				' .uagb-timeline__events-inner--content' => array(
					'padding-left'   => Spectra_Helper::get_css_value( $attr['leftPaddingMobile'], $attr['mobilePaddingUnit'] ),
					'padding-right'  => Spectra_Helper::get_css_value( $attr['rightPaddingMobile'], $attr['mobilePaddingUnit'] ),
					'padding-top'    => Spectra_Helper::get_css_value( $attr['topPaddingMobile'], $attr['mobilePaddingUnit'] ),
					'padding-bottom' => Spectra_Helper::get_css_value( $attr['bottomPaddingMobile'], $attr['mobilePaddingUnit'] ),
					'border-radius'  => Spectra_Helper::get_css_value( $attr['borderRadiusMobile'], 'px' ),
				),
			);
			return $m_selectors;
		...
		public static function get_gallery_css( $attr, $id ) {
				...
				if ( isset( $attr['masonryGutter'] ) && '' !== $attr['masonryGutter'] ) {
					$selectors = array(
						'.wp-block-gallery.has-nested-images.columns-' . $col_count => array(
							'column-gap' => Spectra_Helper::get_css_value( $attr['masonryGutter'], 'px' ),
						),
						...
						'.wp-block-gallery.has-nested-images figure.wp-block-image:not(#individual-image) img' => array(
							'margin-bottom' => Spectra_Helper::get_css_value( $attr['masonryGutter'], 'px' ),
						),
			...
			return Spectra_Helper::generate_all_css( $combined_selectors, '.uagb-block-' . $id );
		}
		...
		public static function get_masonry_gallery_css() {
			...
			$css = Spectra_Helper::generate_all_css( $combined_selectors, '.uag-masonry' );
		...
		public static function uag_get_background_obj( $bg_obj, $css_for_overlay = '' ) {
			...
			$custom_x_position = Spectra_Helper::get_css_value( $x_position, $x_position_type );
			$custom_y_position = Spectra_Helper::get_css_value( $y_position, $y_position_type );
		...
		public static function uag_generate_border_css( $attr, $prefix, $device = 'desktop' ) {
			...
			if ( 'none' !== $attr[ $prefix . 'BorderStyle' ] && ! empty( $attr[ $prefix . 'BorderStyle' ] ) ) {
				$gen_border_css['border-top-width']    = Spectra_Helper::get_css_value( $attr[ $prefix . 'BorderTopWidth' . $device ], 'px' );
				$gen_border_css['border-left-width']   = Spectra_Helper::get_css_value( $attr[ $prefix . 'BorderLeftWidth' . $device ], 'px' );
				$gen_border_css['border-right-width']  = Spectra_Helper::get_css_value( $attr[ $prefix . 'BorderRightWidth' . $device ], 'px' );
				$gen_border_css['border-bottom-width'] = Spectra_Helper::get_css_value( $attr[ $prefix . 'BorderBottomWidth' . $device ], 'px' );
			}
			$gen_border_unit                                  = isset( $attr[ $prefix . 'BorderRadiusUnit' . $device ] ) ? $attr[ $prefix . 'BorderRadiusUnit' . $device ] : 'px';
				$gen_border_css['border-top-left-radius']     = Spectra_Helper::get_css_value( $attr[ $prefix . 'BorderTopLeftRadius' . $device ], $gen_border_unit );
				$gen_border_css['border-top-right-radius']    = Spectra_Helper::get_css_value( $attr[ $prefix . 'BorderTopRightRadius' . $device ], $gen_border_unit );
				$gen_border_css['border-bottom-left-radius']  = Spectra_Helper::get_css_value( $attr[ $prefix . 'BorderBottomLeftRadius' . $device ], $gen_border_unit );
				$gen_border_css['border-bottom-right-radius'] = Spectra_Helper::get_css_value( $attr[ $prefix . 'BorderBottomRightRadius' . $device ], $gen_border_unit );
		...
		public static function uag_generate_deprecated_border_css( $current_css, $border_width, $border_radius, $border_color = '', $border_style = '' ) {
			...
			if ( ! empty( $current_css ) && isset( $current_css['border-style'] ) && 'default' !== $current_css['border-style'] ) {
				...
				$gen_border_css['border-top-width']    = ( isset( $current_css['border-top-width'] ) && ( ! empty( $current_css['border-top-width'] ) || 0 === $current_css['border-top-width'] ) ) ? $current_css['border-top-width'] : Spectra_Helper::get_css_value( $border_width, 'px' );
				$gen_border_css['border-left-width']   = ( isset( $current_css['border-left-width'] ) && ( ! empty( $current_css['border-left-width'] ) || 0 === $current_css['border-left-width'] ) ) ? $current_css['border-left-width'] : Spectra_Helper::get_css_value( $border_width, 'px' );
				$gen_border_css['border-right-width']  = ( isset( $current_css['border-right-width'] ) && ( ! empty( $current_css['border-right-width'] ) || 0 === $current_css['border-right-width'] ) ) ? $current_css['border-right-width'] : Spectra_Helper::get_css_value( $border_width, 'px' );
				$gen_border_css['border-bottom-width'] = ( isset( $current_css['border-bottom-width'] ) && ( ! empty( $current_css['border-bottom-width'] ) || 0 === $current_css['border-bottom-width'] ) ) ? $current_css['border-bottom-width'] : Spectra_Helper::get_css_value( $border_width, 'px' );

				$gen_border_css['border-top-left-radius']     = ( isset( $current_css['border-top-left-radius'] ) && ( ! empty( $current_css['border-top-left-radius'] ) || 0 === $current_css['border-top-left-radius'] ) ) ? $current_css['border-top-left-radius'] : Spectra_Helper::get_css_value( $border_radius, 'px' );
				$gen_border_css['border-top-right-radius']    = ( isset( $current_css['border-top-right-radius'] ) && ( ! empty( $current_css['border-top-right-radius'] ) || 0 === $current_css['border-top-right-radius'] ) ) ? $current_css['border-top-right-radius'] : Spectra_Helper::get_css_value( $border_radius, 'px' );
				$gen_border_css['border-bottom-left-radius']  = ( isset( $current_css['border-bottom-left-radius'] ) && ( ! empty( $current_css['border-bottom-left-radius'] ) || 0 === $current_css['border-bottom-left-radius'] ) ) ? $current_css['border-bottom-left-radius'] : Spectra_Helper::get_css_value( $border_radius, 'px' );
				$gen_border_css['border-bottom-right-radius'] = ( isset( $current_css['border-bottom-right-radius'] ) && ( ! empty( $current_css['border-bottom-right-radius'] ) || 0 === $current_css['border-bottom-right-radius'] ) ) ? $current_css['border-bottom-right-radius'] : Spectra_Helper::get_css_value( $border_radius, 'px' );
		...
		private static function get_block_default_attributes( $block_name ) {
			$assets_file = realpath( SPECTRA_DIR . 'includes/blocks/' . basename( $block_name ) . '/attributes.php' );
		...
		public static function generate_border_radius( $unit, $topLeft, $topRight = null, $bottomRight = null, $bottomLeft = null ) {
			$borderRadius = ! is_null( $topRight )
				? (
					...
					? (
						! is_null( $bottomLeft )
						? Spectra_Helper::get_css_value( $topLeft, $unit ) . ' ' . Spectra_Helper::get_css_value( $topRight, $unit ) . ' ' . Spectra_Helper::get_css_value( $bottomRight, $unit ) . ' ' . Spectra_Helper::get_css_value( $bottomLeft, $unit )
						: Spectra_Helper::get_css_value( $topLeft, $unit ) . ' ' . Spectra_Helper::get_css_value( $topRight, $unit ) . ' ' . Spectra_Helper::get_css_value( $bottomRight, $unit )
					)
					: Spectra_Helper::get_css_value( $topLeft, $unit ) . ' ' . Spectra_Helper::get_css_value( $topRight, $unit )
				)
				: Spectra_Helper::get_css_value( $topLeft, $unit );
			return $borderRadius;
		}
		...
		public static function generate_spacing( $unit, $top, $right = null, $bottom = null, $left = null ) {
			$spacing = ! is_null( $right )
				? (
					...
					? (
						! is_null( $left )
						? Spectra_Helper::get_css_value( $top, $unit ) . ' ' . Spectra_Helper::get_css_value( $right, $unit ) . ' ' . Spectra_Helper::get_css_value( $bottom, $unit ) . ' ' . Spectra_Helper::get_css_value( $left, $unit )
						: Spectra_Helper::get_css_value( $top, $unit ) . ' ' . Spectra_Helper::get_css_value( $right, $unit ) . ' ' . Spectra_Helper::get_css_value( $bottom, $unit )
					)
					: Spectra_Helper::get_css_value( $top, $unit ) . ' ' . Spectra_Helper::get_css_value( $right, $unit )
				)
				: Spectra_Helper::get_css_value( $top, $unit );
			return $spacing;
		}
		...
		public static function generate_shadow_css( $shadow_properties ) {
			...
			$horizontal = Spectra_Helper::get_css_value( $horizontal, $horizontal_unit );
			if ( '' === $horizontal ) {
				$horizontal = 0;
			}

			$vertical = Spectra_Helper::get_css_value( $vertical, $vertical_unit );
			if ( '' === $vertical ) {
				$vertical = 0;
			}

			$blur = Spectra_Helper::get_css_value( $blur, $blur_unit );
			if ( '' === $blur ) {
				$blur = 0;
			}

			$spread = Spectra_Helper::get_css_value( $spread, $spread_unit );
			if ( '' === $spread ) {
				$spread = 0;
			}
