...
$day_label     = $attributes['dayLabel'] ?? __( 'Day', 'spectra' );
$days_label    = $attributes['daysLabel'] ?? __( 'Days', 'spectra' );
$hour_label    = $attributes['hourLabel'] ?? __( 'Hour', 'spectra' );
$hours_label   = $attributes['hoursLabel'] ?? __( 'Hours', 'spectra' );
$minute_label  = $attributes['minuteLabel'] ?? __( 'Minute', 'spectra' );
$minutes_label = $attributes['minutesLabel'] ?? __( 'Minutes', 'spectra' );
$second_label  = $attributes['secondLabel'] ?? __( 'Second', 'spectra' );
$seconds_label = $attributes['secondsLabel'] ?? __( 'Seconds', 'spectra' );
...
if ( 'off' !== $aria_live_type ) {
	$aria_attributes['aria-label'] = __( 'Countdown timer', 'spectra' );
}
