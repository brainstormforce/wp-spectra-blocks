...
<div <?php echo wp_kses_data( $wrapper_attributes ); ?>>
	...
	<div 
		...
		<?php if ( 'popup' === $variant_type ) : ?>
			role="dialog"
			aria-modal="true"
			aria-label="<?php echo esc_attr__( 'Popup content', 'spectra' ); ?>"
		<?php else : ?>
			role="region"
			aria-label="<?php echo esc_attr__( 'Information banner', 'spectra' ); ?>"
		<?php endif; ?>
		aria-hidden="true"
		tabindex="-1"
	>
