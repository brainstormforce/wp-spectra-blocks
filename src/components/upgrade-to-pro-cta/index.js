...
/**
 * UpgradeComponent renders an inline upsell banner for Spectra Blocks Pro features.
 *
 * @since x.x.x
 * @param {Object} props          Component props.
 * @param {Object} props.control  Control config including `campaign` key.
...
const UpgradeComponent = ( props ) => {
	...
	return (
		<>
			<div className="spectra-blocks-upgrade-pro-wrap">
...
const ProModal = ( { modalData, setIsModalOpen } ) => {
	...
	const contryCode = spectra_blocks_info.contry_code;
			...
			{ loading ? (
				...
				<>
					...
					<div className="flex justify-end md:pr-[10px] pr-2 w-full">
						<a
							href={ spectra_blocks_info?.upsellModalEditor }
							target="_blank"
							rel="noreferrer"
							className="text-xxs text-brand-primary-600 spectra-blocks-remove-ring"
						>
