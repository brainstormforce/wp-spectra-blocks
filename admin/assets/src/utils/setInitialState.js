...
const setInitialState = ( store ) => {
    apiFetch( {
        ...
        const initialState = {
			...
			enableLegacyDesignLibrary: data.uag_enable_legacy_design_library,
			enableAutoBlockRecovery: data.uag_auto_block_recovery,
			disableCSSCache: data.uag_disable_css_cache,
			social: data.social,
			...
			isOldUserLessThanV3: data.uagb_old_user_less_than_3,
			enableRegisterV2Blocks: data.enable_register_v2_blocks,
        };
