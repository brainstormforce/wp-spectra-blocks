...
const setInitialState = ( store ) => {
    apiFetch( {
        ...
        const initialState = {
			...
			contentWidth: data.spectra_blocks_content_width,
			...
			visibilityMode: data.spectra_blocks_visibility_mode,
			visibilityPage: data.visibility_page,
			blocksEditorSpacing: data.spectra_blocks_blocks_editor_spacing,
			...
			enableFontAwesome5: data.spectra_blocks_load_font_awesome_5,
			enableLegacyDesignLibrary: data.spectra_blocks_enable_legacy_design_library,
