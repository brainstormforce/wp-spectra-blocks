...
export const proBlocks = [
	{
		...
		icon: React.cloneElement( Spectra_Block_Icons.login, { className: 'w-5 h-5' } ),
		is_pro: true,
		is_active: null,
		is_core: false,
		is_extension: false,
...

	{
		...
		icon: React.cloneElement( Spectra_Block_Icons.register, { className: 'w-5 h-5' } ),
		is_pro: true,
		is_active: null,
		is_core: false,
		is_extension: false,
...

	{
		...
		icon: React.cloneElement( Spectra_Block_Icons[ 'loop-builder' ], { className: 'w-5 h-5' } ),
		is_pro: true,
		is_active: null,
		is_core: false,
		is_extension: false,
	...
	{
		title: __( 'Global Block Style', 'spectra-blocks' ),
	...
	},
	{
		...
		slug: 'modal',
		link: 'modal-block',
		icon: React.cloneElement( Spectra_Block_Icons.modal, { className: 'w-5 h-5' } ),
		is_pro: true,
		is_active: null,
		is_core: false,
		is_extension: true,
	...
	{
		title: __( 'Countdown Pro', 'spectra-blocks' ),
		slug: 'countdown',
		link: 'countdown-pro',
		icon: React.cloneElement( Spectra_Block_Icons.countdown, { className: 'w-5 h-5' } ),
		is_pro: true,
		is_active: null,
		is_core: false,
		is_extension: true,
	},
	{
		...
		slug: 'slider',
		link: 'slider-block',
		icon: React.cloneElement( Spectra_Block_Icons.slider, { className: 'w-5 h-5' } ),
		is_pro: true,
		is_active: null,
		is_core: false,
		is_extension: true,
	...
	{
		title: __( 'Image Gallery Pro', 'spectra-blocks' ),
		slug: 'image-gallery',
		link: 'image-gallery',
		icon: React.cloneElement( Spectra_Block_Icons[ 'image-gallery' ], { className: 'w-5 h-5' } ),
		is_pro: true,
		is_active: null,
		is_core: false,
		is_extension: true,
