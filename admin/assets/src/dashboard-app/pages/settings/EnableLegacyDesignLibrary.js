...
const EnableLegacyDesignLibrary = () => {
    ...
    const updateEnableLegacyDesignLibraryStatus = () => {
        ...
        const data = {
            security: spectra_blocks_react.enable_legacy_design_library_nonce,
            value: assetStatus,
        };
        // Call the getApiData function with the specified parameters
        const getApiFetchData = getApiData( {
            url: spectra_blocks_react.ajax_url,
            action: 'spectra_blocks_enable_legacy_design_library',
            data,
        } );
    ...
    return (
        <>
			<SettingsItem
				title={ __( 'Enable Legacy Content', 'spectra-blocks' ) }
				settingText={ __( 'Access legacy Kits, Patterns, and Blocks from earlier versions of Spectra.', 'spectra-blocks' ) }
			>
				<Switch
