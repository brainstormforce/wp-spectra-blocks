...
**For Developers**: See [ARCHITECTURE.md](ARCHITECTURE.md) for detailed information about the v3-only plugin architecture, folder structure, and development workflow.
