...
class Animations {
	...
	public function enqueue_block_assets() {
		...
		if ( ! wp_script_is( 'uagb-aos-js', 'registered' ) ) {
			wp_register_script( 'uagb-aos-js', SPECTRA_BLOCKS_URL . 'assets/js/aos.min.js', array(), SPECTRA_BLOCKS_VER, true );
		}

		if ( ! wp_style_is( 'uagb-aos-css', 'registered' ) ) {
			wp_register_style( 'uagb-aos-css', SPECTRA_BLOCKS_URL . 'assets/css/aos.min.css', array(), SPECTRA_BLOCKS_VER );
		}
