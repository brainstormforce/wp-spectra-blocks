...
class ResponsiveConditions {
	...
	private function is_allowed_block( $block_name ) {
		 ...
		 */
		$supported_blocks = apply_filters( 'spectra_blocks_supported_responsive_conditions_blocks', array( 'core/image' ), $block_name );
		 ...
		 */
		$allowed_prefixes = apply_filters( 'spectra_blocks_allowed_responsive_conditions_prefixes', array( 'spectra/', 'spectra-pro/' ), $block_name );
