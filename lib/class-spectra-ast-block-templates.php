...
if ( ! class_exists( 'Spectra_Ast_Block_Templates' ) ) :
	...
	class Spectra_Ast_Block_Templates {
		 ...
		 *
		 * @since 0.0.1
		 * @var (Object) Spectra_Ast_Block_Templates
		 */
		...
		public function update_vars( $vars = array() ) {
			...
			$vars['button_text']         = __( 'Design Library', 'spectra' );
			$vars['display_button_logo'] = true;
			$vars['popup_logo_uri']      = SPECTRA_URL . 'admin/assets/images/uag-logo.svg';
			$vars['button_logo']         = SPECTRA_URL . 'admin/assets/images/btn-spectra.svg';
	 ...
	 */
	Spectra_Ast_Block_Templates::get_instance();
